...
Examples:
  ...
  python show_session.py --cwd C:\\path\\to\\project --latest
...
def main() -> int:
    ...
    p.add_argument("--max-thinking", type=int, default=600,
                   help="When --include-thinking is set, truncate thinking to this many chars (default: 600). "
                        "0 = no truncation. Set to -1 to omit thinking.")
    p.add_argument("--include-thinking", action="store_true",
                   help="Include assistant thinking content (opt-in).")
